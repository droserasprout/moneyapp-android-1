 ...
 * @author vpotapenko
 */
public class MonthPeriodWalker implements IPeriodWalker {

    private final int startFrom;

    public MonthPeriodWalker(int startFrom) {
    ...
    public Pair<Date, Date> getCurrent() {
        ...
        while (cal.get(Calendar.DATE) != startFrom) {
    ...
    public boolean same(int type, int startFrom) {
        return type == Period.MONTH_TYPE && this.startFrom == startFrom;
    }
}
